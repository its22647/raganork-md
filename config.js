...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '𝓐𝓪𝓶𝓲𝓻;𝑨𝒂𝒎𝒊𝒓;𝐀𝐚𝐦𝐢𝐫;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,92',
    NOT_ALLOWED: process.env.ALLOWED || '91,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Created by",
    BOT_NAME: process.env.BOT_NAME || '𝐀𝐚𝐦𝐢𝐫',
